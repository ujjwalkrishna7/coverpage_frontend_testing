...
const FeatureIconContainer = styled.div`
  ${tw`z-10 mx-auto inline-block border-2 border-primary-500 text-primary-500 text-center rounded-full w-10 h-10 
  flex-shrink-0 flex items-center justify-center hover:bg-primary-500 hover:text-gray-100`}
`;
